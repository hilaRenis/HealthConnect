...
import { Typography, Container, TextField, Button, Paper, List, ListItem, ListItemText } from '@mui/material';
...
const PatientDashboard = () => {
  ...
  const { register: registerPrescription, handleSubmit: handleSubmitPrescription, reset: resetPrescription } = useForm();
